...
Essayons de voir l'indice de réactivité des gouvernements de ces pays, et de la France pour comperer, face à la pandémie.
```{r}
...
On remarque que le jeu de données n'inclut pas l'indice en question de certains de ces pays. Comme on l'aurait deviné, l'indice se ces pays est en moyenne moins de celui de la France.
Intéressons nous au classement des pays par rapport à cet indice.
